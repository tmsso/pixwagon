...
- Record decisions where they will be found later: a one-line "Decided" entry under the phase in `ROADMAP.md` plus a comment at the site of the decision; narrative goes in `docs/delivery-log.md`. Decisions of that weight (like the roadmap's D1–D4, decided 2026-09-16) are the admin's call — ask them up front, once, at the start of a batch.
